...
public class LITPdnsclientapiTestRunner extends TorTestCaseHelper {
    
    Logger logger = Logger.getLogger(LITPdnsclientapiTestRunner.class);
    ...
    @TestId(id = "CXP9031172-1", title = "Upgrade ERIClitpdnsclientapi rpm on the MS")
    @Test(groups={"ACCEPTANCE"})
    public void upgradeERIClitpdnsclientapiRPM() throws TimeoutException, FileNotFoundException {

        rpmUpgradeOperator.initialise("dnsclientapi");
     ...
     * @PRIORITY HIGH
     */
    @TestId(id = "CXP9031172-2", title = "Run python test cases for ERIClitpdnsclientapi package")
    @Test(groups={"CDB_REGRESSION", "ACCEPTANCE"})
    public void runERIClitpdnsclientapiTests() {
     ...
     * @PRE Execution of test {@link #runERIClitpdnsclientapiTests()}
     * @PRIORITY HIGH
     * @param className
     * @param name
     * @param failures
     */
    @TestId(id = "CXP9031172-3", title = "Parse xml outputs from python tests")
